...
public class LoadMap{
    ...
    public static void main(String[] args){
        ...
        LoadMap loadArena1 = new LoadMap();
        ...
        //loadArena1.setCurrGridMap(directoryPath+"testArena4.txt", false);
        //loadArena1.setCurrGridMap(directoryPath+"sampleArena1.txt", true);
        //loadArena1.setCurrGridMap(directoryPath+"sampleArena2.txt", true);
        loadArena1.setCurrGridMap(directoryPath+"sampleArena5.txt", true);
        //loadArena1.setCurrGridMap(directoryPath+"hexSampleArena3.txt", false);
        ...
        button.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
              ...
              /* loadArena1.setCurrMapPanel();//update map panel again with updated paint list
              mainPanel.revalidate();
              mainPanel.repaint(); */
            } 
          });
